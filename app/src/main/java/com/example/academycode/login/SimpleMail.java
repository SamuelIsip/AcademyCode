...
public class SimpleMail {
    ...
    private static final String SMTP_AUTH_USER = "academycodemail@gmail.com"; //your login username/email
    private static final String SMTP_AUTH_PWD  = "myusersamuel123456"; //password/secret
